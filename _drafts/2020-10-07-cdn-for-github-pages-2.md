...
如果想将这个图片地址替换为 jsDelivr 的地址，需要做的就是将 `/images` 替换为 `https://fastly.jsdelivr.net/gh/aipangu/aipangu.github.io@master/images`。
...
大意就是，如果打开了启用 jsDelivr 加速的开关，就将 `content` 里的 `src="/images"` 替换为 `src="https://fastly.jsdelivr.net/gh/aipangu/aipangu.github.io@master/images"`，否则替换为 `src="https://koalai.org/images"`。
...
<https://github.com/aipangu/aipangu.github.io/blob/master/assets/search_data.json>
...
4. 修改引用 JSON 文件的地方，比如我的 _includes/sidebar-search.html 里的写法由：
    ...
    {% if site.cdn.jsdelivr.enabled and site.url contains 'koalai.org' %}
      json: 'https://fastly.jsdelivr.net/gh/aipangu/aipangu.github.io@built/assets/search_data.json',
    {% else %}
      json: '{{ site.url }}/assets/search_data.json',
    {% endif %}
    ```
...
经过以上改造，博客页面的加载速度又得到了小小的提升，所有相关源码可以在 <https://github.com/aipangu/aipangu.github.io> 找到，有相关心得或建议的朋友欢迎交流指正。
